...
const Navbar = () => {
    ...
    return ( <>{showNavbar && <nav className='bg-white w-[80vw] flex mix-blend-luminosity justify-between fixed top-10 right-[10vw] rounded-full p-5 px-7'>
            <div className="logo flex gap-20 items-center">
                ...
                <ul className='flex gap-10 text-gray-500 font-medium '>
                    <Link className='hover:text-black transition-all' href="/"><li>Templates </li></Link>
                    <Link className='hover:text-black transition-all' href="/"><li>Marketplace</li></Link>
                    <Link className='hover:text-black transition-all' href="/"><li>Discover</li></Link>
                    <Link className='hover:text-black transition-all' href="/"><li>Pricing</li></Link>
                    <Link className='hover:text-black transition-all' href="/"><li>Learn</li></Link>
                </ul>
            </div>

            <div className='flex gap-3'>
                <button className="login hover:bg-gray-500 transition-all bg-gray-900 p-3 rounded-lg font-bold">Log in</button>
                <button className="signup hover:bg-gray-500 transition-all bg-gray-900 text-white font-bold p-3 rounded-full"> Sign up </button>
            </div>
        </nav>}
        </>
